 ...
 */
public class WithoutHTProcessorCountPublisherToOneProcessorThroughputTestSynchronized
{
    ...
    public WithoutHTProcessorCountPublisherToOneProcessorThroughputTestSynchronized()
    {
    ...
    {
        WithoutHTProcessorCountPublisherToOneProcessorThroughputTestSynchronized
                test = new WithoutHTProcessorCountPublisherToOneProcessorThroughputTestSynchronized();
        test.startTest();
    }
