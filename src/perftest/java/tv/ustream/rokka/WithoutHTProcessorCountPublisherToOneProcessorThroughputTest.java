 ...
 */
public class WithoutHTProcessorCountPublisherToOneProcessorThroughputTest
{
    ...
    public WithoutHTProcessorCountPublisherToOneProcessorThroughputTest()
    {
    ...
    {
        WithoutHTProcessorCountPublisherToOneProcessorThroughputTest
                test = new WithoutHTProcessorCountPublisherToOneProcessorThroughputTest();
        test.startTest();
    }
