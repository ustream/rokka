 ...
 */
public class WithoutHTProcessorCountPublisherToOneProcessorThroughputTestLinkedBlockingQueue
{
    private static final int PUBLISHER_THREAD_NUMBER = Runtime.getRuntime().availableProcessors()/2;
    ...
    public WithoutHTProcessorCountPublisherToOneProcessorThroughputTestLinkedBlockingQueue()
    {
    ...
    {
        WithoutHTProcessorCountPublisherToOneProcessorThroughputTestLinkedBlockingQueue
                test = new WithoutHTProcessorCountPublisherToOneProcessorThroughputTestLinkedBlockingQueue();
        test.startTest();
    }
