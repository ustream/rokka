 ...
 */
public class AvailableProcessorCountPublisherToOneProcessorThroughputTestReentrantLock
{
    ...
    public AvailableProcessorCountPublisherToOneProcessorThroughputTestReentrantLock()
    {
    ...
    {
        AvailableProcessorCountPublisherToOneProcessorThroughputTestReentrantLock
                test = new AvailableProcessorCountPublisherToOneProcessorThroughputTestReentrantLock();
        test.startTest();
    }
