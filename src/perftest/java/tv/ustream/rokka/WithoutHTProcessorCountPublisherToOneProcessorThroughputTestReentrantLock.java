 ...
 */
public class WithoutHTProcessorCountPublisherToOneProcessorThroughputTestReentrantLock
{
    ...
    public WithoutHTProcessorCountPublisherToOneProcessorThroughputTestReentrantLock()
    {
    ...
    {
        WithoutHTProcessorCountPublisherToOneProcessorThroughputTestReentrantLock
                test = new WithoutHTProcessorCountPublisherToOneProcessorThroughputTestReentrantLock();
        test.startTest();
    }
